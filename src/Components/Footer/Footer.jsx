...
import { class_image } from "../../assets";
import { Link } from "react-router-dom";
class_image;
const Footer = () => {
  return (
    <>
      <footer className="w-full bg-gray-100 dark:bg-gray-900 py-16 mt-10 ">
        <div className="md:px-12 lg:px-28">
          <div className="container m-auto space-y-6 text-gray-600 dark:text-gray-300">
            <img src={class_image} alt="" className="m-auto w-24 " />
            <ul
              role="list"
            ...
            <div className="text-center">
              <span className="text-sm tracking-wide">
                Copyright © Lukman <span id="year"></span> | All right reserved
              </span>
            </div>
          </div>
        </div>
